...
function AuthProvider({children}){
    ...
    const nomeCandidatosClassificacaoOld = [
  ...
  const nomeCandidatosClassificacao = [
    { nome: 'Janaina Oliveira Lacerda', classificacao: 1 },
    { nome: 'Edson Augusto Alves Da Silva', classificacao: 2 },
    { nome: 'Henrique Lima Dos Santos', classificacao: 3 },
    { nome: 'Fernando Agues De Oliveira', classificacao: 4 },
    { nome: 'Gleiciane Santos Costa', classificacao: 5 },
    { nome: 'Pedro Elias Da Silveira', classificacao: 6 },
    { nome: 'Lucas Matheus Barbosa Deoliveira', classificacao: 7 },
    { nome: 'Reuhel Da Silva Cavalcante', classificacao: 8 },
    { nome: 'João Victor Francisquett Dos Santos', classificacao: 9 },
    { nome: 'Mauri Kehl Junior', classificacao: 10 },
    { nome: 'Vinicius Moretti De Paula', classificacao: 11 },
    { nome: 'William Marcari Ribeiro Barros', classificacao: 12 },
    { nome: 'Luciene Sales Dos Santos', classificacao: 13 },
    { nome: 'Julio Cesar Silva Rodrigues', classificacao: 14 },
    { nome: 'Larissa Aryane Galvão', classificacao: 15 },
    { nome: 'Thayloane Souza Da Silva Luz', classificacao: 16 },
    { nome: 'Paulo Sérgio Akieda', classificacao: 17 },
    { nome: 'Alexsandra Carolina Guimarães De Oliveira', classificacao: 18 },
    { nome: 'Fernanda Cardoso Wolf', classificacao: 19 },
    { nome: 'Renato Arthur Fabro Dos Santos', classificacao: 20 },
    { nome: 'Bruna Quezini Da Silva', classificacao: 21 },
    { nome: 'Meiri Anita Nichetti Haach', classificacao: 22 },
    { nome: 'Willian Dias Da Silva Junior', classificacao: 23 },
    { nome: 'André Luiz Ferreira Da Silva', classificacao: 24 },
    { nome: 'Ronaldo Lopes Maciel', classificacao: 25 },
    { nome: 'Juliana Romeiro Salina', classificacao: 26 },
    { nome: 'Thiago Alberto Valle Do Nascimento', classificacao: 27 },
    { nome: 'Gustavo Cesar Domingues De Oliveira', classificacao: 28 },
    { nome: 'Murilo Brendo Dias Lins', classificacao: 29 },
    { nome: 'Edmilson Camargo Da Silva', classificacao: 30 },
    { nome: 'Mariana Maria Rodrigues Zito', classificacao: 31 },
    { nome: 'André De Lima Benteo', classificacao: 32 },
    { nome: 'Vitoria Caroline Barboza Fernandes De Souza', classificacao: 33 },
    { nome: 'Gabriela Ribeiro Mendonça Maldonado', classificacao: 34 },
    { nome: 'Lyncon Marques', classificacao: 35 },
    { nome: 'Rodrigo Alves Barros', classificacao: 36 },
    { nome: 'Elliot Jacques Lima', classificacao: 37 },
    { nome: 'Carlos Henrique Alves Rodrigues', classificacao: 38 },
    { nome: 'Pedro Henrique Figueiredo Barbosa', classificacao: 39 },
    { nome: 'Edson Eduardo Fernandes Amarilha', classificacao: 40 },
    { nome: 'Wesley Mendonça De Brito Silva', classificacao: 41 },
    { nome: 'José Gomes De Andrade Neto', classificacao: 42 },
    { nome: 'Ludiér Mariano Rosa', classificacao: 43 },
    { nome: 'Osmar Vasques Gonzalez', classificacao: 44 },
    { nome: 'Cassiano Lucas Simplicio Batistote', classificacao: 45 },
    { nome: 'Larissa Arguilera De Paula (Sub judice)', classificacao: 46 },
    { nome: 'Bruno Maciel Garcia', classificacao: 47 },
    { nome: 'Pedro Gabriel Teles Barbosa', classificacao: 48 },
    { nome: 'Viviane Cassemiro De Almeida Canepa', classificacao: 49 },
    { nome: 'Vítor Da Rocha Dias Duarte', classificacao: 50 },
    { nome: 'Camila Da Silva Calixto Aguirre', classificacao: 51 },
    { nome: 'Wesley Alves Costa', classificacao: 52 },
    { nome: 'Arthur Araujo Do Nascimento', classificacao: 53 },
    { nome: 'Claudieli Tanara Wottrich Timm', classificacao: 54 },
    { nome: 'Igor De Oliveira Salina (Sub judice)', classificacao: 55 },
    { nome: 'Lucas Figale Cardoso', classificacao: 56 },
    { nome: 'Monique Ortiz Santana', classificacao: 57 },
    { nome: 'Lucas De Oliveira Diniz', classificacao: 58 },
    { nome: 'Luis Fernando Pereira Pinto', classificacao: 59 },
    { nome: 'Aline Gomes Gonçalves', classificacao: 60 },
    { nome: 'Melany Estevao Barbosa Soares (Sub judice)', classificacao: 61 },
    { nome: 'Clovis De Souza Rocha', classificacao: 62 },
    { nome: 'Leandro Dos Santos Pereira', classificacao: 63 },
    { nome: 'Giovanny Souza Da Fonseca', classificacao: 64 },
    { nome: 'Ricardo Junior Alves Kurovski', classificacao: 65 },
    { nome: 'Alexandre Bernardes Gomes Da Silva', classificacao: 66 },
    { nome: 'Denner Douglas Medeiros Soares', classificacao: 67 },
    { nome: 'Thaisson Oliveira Da Silva', classificacao: 68 },
    { nome: 'Edson Maximo Romero Junior', classificacao: 69 },
    { nome: 'Luiz Fernando Nunes', classificacao: 70 },
    { nome: 'Valleria Orso Valmini Siqueira', classificacao: 71 },
    { nome: 'Johnne Alex Batista Gomes', classificacao: 72 },
    { nome: 'Lucas Anthony Alves Barros', classificacao: 73 },
    { nome: 'Nícolas Nogueira Duailibi', classificacao: 74 },
    { nome: 'Nicole Roda Rodrigues', classificacao: 75 },
    { nome: 'Douglas Soares Regini', classificacao: 76 },
    { nome: 'Fernanda Silva Marques', classificacao: 77 },
    { nome: 'Anderson Barroso De Almeida', classificacao: 78 },
    { nome: 'Elivander Sanches Honorato', classificacao: 79 },
    { nome: 'Rewller Vianna Da Silva', classificacao: 80 },
    { nome: 'Bruno Vinicius Da Silva Abreu', classificacao: 81 },
    { nome: 'Samuel De Souza Queiroz', classificacao: 82 },
    { nome: 'Dalvan Bruno Ferreira Da Silva', classificacao: 83 },
    { nome: 'Daniella Ferreira Leite', classificacao: 84 },
    { nome: 'Raissa Maria Alves Vida', classificacao: 85 },
    { nome: 'Bruno Antonio Dos Reis', classificacao: 86 },
    { nome: 'Maria Eduarda Avelino Prates', classificacao: 87 },
    { nome: 'Emerson Rodrigo Pereira Dos Santos', classificacao: 88 },
    { nome: 'Graciely Ferreira Rodrigues', classificacao: 89 },
    { nome: 'Cristina Schultz Kuhn', classificacao: 90 },
    { nome: 'Lorena Pereira De Souza', classificacao: 91 },
    { nome: 'Izabelle Souza Delaterra De Assis', classificacao: 92 },
    { nome: 'Cleyton Cassiano Ribeiro Rodrigues', classificacao: 93 },
    { nome: 'Ygor Garcia De Oliveira', classificacao: 94 },
    { nome: 'Albert Natan De Oliveira Medeiros', classificacao: 95 },
    { nome: 'Wesley Vinicius Bordas De Figueiredo', classificacao: 96 },
    { nome: 'Matheus Hemerson Nogueira Rodrigues', classificacao: 97 },
    { nome: 'Lucas Vinícius Conche De Souza', classificacao: 98 },
    { nome: 'Fernanda Caroline Batistoti Simas', classificacao: 99 },
    { nome: 'Eber De Morais Marinhas', classificacao: 100 },
    { nome: 'Larissa Fernandes De Souza', classificacao: 101 },
    { nome: 'Karolyne Freitas Nascimento', classificacao: 102 },
    { nome: 'Isabella Catarina Rodrigues Jacob', classificacao: 103 },
    { nome: 'Maria Estela Da Silva Casanova (Sub judice)', classificacao: 104 },
    { nome: 'Gabriele Bezerra Porto', classificacao: 105 },
    { nome: 'Brenda Rodrigues Ramires Ferreira', classificacao: 106 },
    { nome: 'Aline Szaubram', classificacao: 107 },
    { nome: 'Luciana Tinoco Machado', classificacao: 108 },
    { nome: 'Luiz Felipe Minussi Da Silva', classificacao: 109 },
    { nome: 'Adilson Antunes Martins', classificacao: 110 },
    { nome: 'Brendo De Jesus Da Silva', classificacao: 111 },
    { nome: 'Sergio Willimann De Souza', classificacao: 112 },
    { nome: 'Caio Boaventura Da Silva', classificacao: 113 },
    { nome: 'Michele Petronilo Inzabral', classificacao: 114 },
    { nome: 'Marcelos Simão Basílio Sobrinho', classificacao: 115 },
    { nome: 'Lauana Elisa Ramalho De Souza', classificacao: 116 },
    { nome: 'João Victor Guedes De Lima', classificacao: 117 },
    { nome: 'Fernanda Castelo Girard', classificacao: 118 },
    { nome: 'Herick Matheus De Souza Exteca', classificacao: 119 },
    { nome: 'Carla Caroline Pinto De Arruda', classificacao: 120 },
    { nome: 'Daniel De Jesus Araújo', classificacao: 121 },
    { nome: 'Lucas Nogueira Tote', classificacao: 122 },
    { nome: 'Siéslem Menezes Sanche Pérez', classificacao: 123 },
    { nome: 'Stephanny Karoline Borges Sonchini', classificacao: 124 },
    { nome: 'Debora Brites Ribeiro De Brites', classificacao: 125 },
    { nome: 'Fagner Charles Ramos', classificacao: 126 },
    { nome: 'Breno Rezende Rodrigues', classificacao: 127 },
    { nome: 'Wenyberg De Mello Nunes', classificacao: 128 },
    { nome: 'João Matheus Navarro Dos Santos', classificacao: 129 },
    { nome: 'Raquel Duarte Felipetto', classificacao: 130 },
    { nome: 'Éverton Schirmann Rosati', classificacao: 131 },
    { nome: 'Alana Jaqueline Bellini Oliveira', classificacao: 132 },
    { nome: 'Thalison Moreira Gouveia', classificacao: 133 },
    { nome: 'Rodrigo Do Carmo Souza', classificacao: 134 },
    { nome: 'Igor Figueiró Do Amaral', classificacao: 135 },
    { nome: 'Emilaine Zorzi Leandro', classificacao: 136 },
    { nome: 'Vinicius Brandao Borges', classificacao: 137 },
    { nome: 'Waldemar Santana Oliveira', classificacao: 138 },
    { nome: 'Renan Nogueira Navarro', classificacao: 139 },
    { nome: 'Kevin Macalisrer Nogueira Barcellos', classificacao: 140 },
    { nome: 'Afonso Cabreira Leao', classificacao: 141 },
    { nome: 'Naijara Da Silva Dias', classificacao: 142 },
    { nome: 'Gabriel Lopes Almeida', classificacao: 143 },
    { nome: 'Ricardo Pereira Da Cruz Junior', classificacao: 144 },
    { nome: 'Abner Diniz Sampaio Dos Santos', classificacao: 145 },
    { nome: 'Lucas Batista Silva', classificacao: 146 },
    { nome: 'Joao Gabriel Da Silva Dantas', classificacao: 147 },
    { nome: 'Jaime Gomes De Souza', classificacao: 148 },
    { nome: 'Joao Paulo Pereira Montessi', classificacao: 149 },
    { nome: 'Luiz Eduardo Da Paz Vitor', classificacao: 150 },
    { nome: 'Kamaykel Santos De Oliveira', classificacao: 151 },
    { nome: 'Adriano Hilario Talarico Soletti', classificacao: 152 },
    { nome: 'Patricia De Kassia Vasconcelos', classificacao: 153 },
    { nome: 'William Geovani Pinesso', classificacao: 154 },
    { nome: 'Maraisa Mendes', classificacao: 155 },
    { nome: 'Luiz Henrique Martins Medeiros', classificacao: 156 },
    { nome: 'Ana Carolina Vituriano Souza', classificacao: 157 },
    { nome: 'Marcus Vinicius Neves Caetano', classificacao: 158 },
    { nome: 'Lucas Ribeiro Pires', classificacao: 159 },
    { nome: 'Lucas Da Silva Machado', classificacao: 160 },
    { nome: 'Diogenes Mauricio Machado', classificacao: 161 },
    { nome: 'Rodrigo Duarte Bono Belascusa', classificacao: 162 },
    { nome: 'Gabrielly Aparecida Marques Ribeiro', classificacao: 163 },
    { nome: 'Eurico Renan Martins Dos Santos', classificacao: 164 },
    { nome: 'Eliseo Brites De Moraes Neto', classificacao: 165 },
    { nome: 'Renata Camila Da Costa Silva', classificacao: 166 },
    { nome: 'Laís Michels Fonseca', classificacao: 167 },
    { nome: 'Arthur Victor Leon Caiubi Souza Silva', classificacao: 168 },
    { nome: 'Eder Benites Petzold', classificacao: 169 },
    { nome: 'Bruno Henrique Simões', classificacao: 170 },
    { nome: 'Eberle Taysson Pereira Maciel', classificacao: 171 },
    { nome: 'Vanessa Mendes Da Silva De Oliveira (Sub judice)', classificacao: 172 },
    { nome: 'Juliany Brito De Araujo', classificacao: 173 },
    { nome: 'Moacir Felipe Araujo Lescano', classificacao: 174 },
    { nome: 'Larissa Iara Alem de Oliveira', classificacao: 175 },
    { nome: 'Giovana Viêro Peccini', classificacao: 176 },
    { nome: 'Bianca Cassupa Pereira', classificacao: 177 },
    { nome: 'Thiago Germano De Figueiredo', classificacao: 178 },
    { nome: 'Jean Carlos Vilela De Melo', classificacao: 179 },
    { nome: 'Carla Priscila Ferreira Miranda', classificacao: 180 },
    { nome: 'Lucas Souza Gimenes', classificacao: 181 },
    { nome: 'Danielle Aguena Martos Costa', classificacao: 182 },
    { nome: 'Neemias De Souza Jeremias', classificacao: 183 },
    { nome: 'Isaias Simoel Gimenez Miotti', classificacao: 184 },
    { nome: 'Fernando Borges Zwicker', classificacao: 185 },
    { nome: 'Jamielle Fernanda Duarte De Amorim', classificacao: 186 },
    { nome: 'Vitor Hugo Da Silva Santos', classificacao: 187 },
    { nome: 'Michael Francisco Da Silva (Sub judice)', classificacao: 188 },
    { nome: 'Rick Kendy Iwashiro', classificacao: 189 },
    { nome: 'Alisson Monteiro Calazans', classificacao: 190 },
    { nome: 'Fernanda Isfran Da Silva', classificacao: 191 },
    { nome: 'Mattheus Cardenas Souza', classificacao: 192 },
    { nome: 'Luís Flávio Isaías Lopes', classificacao: 193 },
    { nome: 'Giovani Teixeira Da Silva (Sub judice)', classificacao: 194 },
    { nome: 'Gustavo Rodrigues Lemes', classificacao: 195 },
    { nome: 'Nathalia Welika Dos Santos Araujo', classificacao: 196 },
    { nome: 'Magno Leoncio Sanches Saraiva', classificacao: 197 },
    { nome: 'Isaque Meleschco Arguelho', classificacao: 198 },
    { nome: 'Lucas Matos Do Nascimento', classificacao: 199 },
    { nome: 'Janaína Da Silva Carvalho Santos', classificacao: 200 },
    { nome: 'Mauricio Matheus De França Araujo', classificacao: 201 },
    { nome: 'Junior Cesar Rodrigues Colombo', classificacao: 202 },
    { nome: 'Gustavo Ribeiro Dos Santos', classificacao: 203 },
    { nome: 'Maíra De Brito Rodrigues Alves', classificacao: 204 },
    { nome: 'Rafael Vasques Ribeiro', classificacao: 205 },
    { nome: 'Thalia Da Silva Bezerra', classificacao: 206 },
    { nome: 'Thor Brum De Oliveira', classificacao: 207 },
    { nome: 'César Francisco Quirino', classificacao: 208 },
    { nome: 'Felipe David De Oliveira', classificacao: 209 },
    { nome: 'Marcos Da Silva Rezende', classificacao: 210 },
    { nome: 'Stefan Wolff', classificacao: 211 },
    { nome: 'Gabrielle Angel Leiko Rezende Nakashima', classificacao: 212 },
    { nome: 'Francisco Rondon Neto', classificacao: 213 },
    { nome: 'Renan Matheus Oliveira Do Nascimento', classificacao: 214 },
    { nome: 'Bruno Noé Eger Sampaio', classificacao: 215 },
    { nome: 'Raquel Aparecida Lima Silva', classificacao: 216 },
    { nome: 'Rafael Henrique Nogueira Roncada', classificacao: 217 },
    { nome: 'Elaine Maria Ramos Dos Santos', classificacao: 218 },
    { nome: 'Henrique Barbosa Coelho', classificacao: 219 },
    { nome: 'Lucas Farias Alves', classificacao: 220 },
    { nome: 'Taina Da Silva', classificacao: 221 },
    { nome: 'José Davi Da Silva De Oliveira', classificacao: 222 },
    { nome: 'Wesley Pereira Dos Santos', classificacao: 223 },
    { nome: 'Rafael Lemos', classificacao: 224 },
    { nome: 'Ana Julia Muniz Lemes', classificacao: 225 },
    { nome: 'Laércio Antonio De Sena Júnior', classificacao: 226 },
    { nome: 'Nikolas Rezende Obregão Nogueira', classificacao: 227 },
    { nome: 'Rogerio Mendes Da Silva', classificacao: 228 },
    { nome: 'Moises Sousa Santiago', classificacao: 229 },
    { nome: 'Fábio Cabral De Moraes', classificacao: 230 },
    { nome: 'Tiago Tadeu Mendes Nepomuceno Salles', classificacao: 231 },
    { nome: 'Hercules Miranda Da Silva', classificacao: 232 },
    { nome: 'Geovane Da Rocha Silva', classificacao: 233 },
    { nome: 'Arthur Natan Santos Silva', classificacao: 234 },
    { nome: 'Matheus Da Cruz Alves', classificacao: 235 },
    { nome: 'Luana Cristina Avelino', classificacao: 236 },
    { nome: 'Álysson Igor Rodrigues Leite', classificacao: 237 },
    { nome: 'João Vitor De Araújo Cunha', classificacao: 238 },
    { nome: 'Quezia Jaime De Jesus', classificacao: 239 },
    { nome: 'Danilo Barbosa Lima De Santana', classificacao: 240 },
    { nome: 'Cleiton Rodrigues De Oliveira', classificacao: 241 },
    { nome: 'Joao Marcos Vilela Lopes', classificacao: 242 },
    { nome: 'Elis Fernanda Da Silva Oliveira', classificacao: 243 },
    { nome: 'Andressa Patricia Soares De Castro', classificacao: 244 },
    { nome: 'Rafael Theodoro Serpa', classificacao: 245 },
    { nome: 'Alberto José Paim De Lima Filho', classificacao: 246 },
    { nome: 'Aline Stefani Lima Ostemberg', classificacao: 247 },
    { nome: 'Gabriel Matheus Gouveia De Lima', classificacao: 248 },
    { nome: 'Amanda Dourado Espindola', classificacao: 249 },
    { nome: 'Paulo André Argerin Rossatto', classificacao: 250 },
    { nome: 'Bárbara Ribeiro Remonti', classificacao: 251 },
    { nome: 'Evania Custódio Lopes', classificacao: 252 },
    { nome: 'Daniel Chaves Martins', classificacao: 253 },
    { nome: 'Tainá Marques Taborga Sandim', classificacao: 254 },
    { nome: 'Paloma Grazielli Gomes Dos Anjos', classificacao: 255 },
    { nome: 'Brian Girotto', classificacao: 256 },
    { nome: 'Gleici Ferreira Furman', classificacao: 257 },
    { nome: 'Fúlvio Souza De Souza', classificacao: 258 },
    { nome: 'Izamara Casadia', classificacao: 259 },
    { nome: 'Douglas Sousa Tosta', classificacao: 260 },
    { nome: 'Vinicius Eduardo De Almeida Santos', classificacao: 261 },
    { nome: 'Patrick Emerson Da Costa', classificacao: 262 },
    { nome: 'Herick Pereira Magalhaes', classificacao: 263 },
    { nome: 'Alana De Sousa Oliveira Gamarra', classificacao: 264 },
    { nome: 'Carla Rebecca Barreto De Aguiar Esteves', classificacao: 265 },
    { nome: 'Lucio Vinicius Santos De Souza', classificacao: 266 },
    { nome: 'Edilene Da Silva Maldonado', classificacao: 267 },
    { nome: 'Daniely Silva De Albuquerque', classificacao: 268 },
    { nome: 'Douglas Brito De Oliveira', classificacao: 269 },
    { nome: 'Bruno Jesus Dourado', classificacao: 270 },
    { nome: 'Kawam Gabriel Rodrigues Campos', classificacao: 271 },
    { nome: 'Thiago Vinicius Fonseca De Oliveira', classificacao: 272 },
    { nome: 'Jefferson Canabarra Peixoto', classificacao: 273 },
    { nome: 'Angélica Freire Bettencourt', classificacao: 274 },
    { nome: 'Leandro Carvalho De Souza', classificacao: 275 },
    { nome: 'Augusto De Almeida Damasceno', classificacao: 276 },
    { nome: 'Renato Ossuna Da Silva', classificacao: 277 },
    { nome: 'Jaiane Dayci Silva', classificacao: 278 },
    { nome: 'Luciano Junior Torale Gonçalves', classificacao: 279 },
    { nome: 'Lucas Henrique De Sena Marques', classificacao: 280 },
    { nome: 'Flavio Alves Ribeiro', classificacao: 281 },
    { nome: 'Willian De Oliveira Papa', classificacao: 282 },
    { nome: 'Liene Cristina De Oliveira Rodrigues Moreira', classificacao: 283 },
    { nome: 'Gabriel De Oliveira Antunes', classificacao: 284 },
    { nome: 'Wesley Souza Almeida', classificacao: 285 },
    { nome: 'Gabriela Caroline De Souza', classificacao: 286 },
    { nome: 'Nathaly Gonçalves Leite Lima', classificacao: 287 },
    { nome: 'Neyenne Caldeira Rocha Lopes', classificacao: 288 },
    { nome: 'Renan Pereira Coimbra', classificacao: 289 },
    { nome: 'Reginaldo Muller Pinto Gerolin', classificacao: 290 },
    { nome: 'Damiao Caboclo Da Silva', classificacao: 291 },
    { nome: 'Marcos Henrique Da Cunha Franco', classificacao: 292 },
    { nome: 'Wellinton Menezes Grance', classificacao: 293 },
    { nome: 'Leonardo Santos Correia', classificacao: 294 },
    { nome: 'Celino Magalhães Filho', classificacao: 295 },
    { nome: 'Mozane Evelin Vilela Teodoro', classificacao: 296 },
    { nome: 'Arthur Rodrigues De Mendonca', classificacao: 297 },
    { nome: 'Marcelo Henrique Nogueira Dos Santos', classificacao: 298 },
    { nome: 'Alessandro Gonçalves Da Silva', classificacao: 299 },
    { nome: 'Thiago Wotekoski Iglesias', classificacao: 300 },
    { nome: 'Fábio Andrade Dos Santos Silva', classificacao: 301 },
    { nome: 'Karthylith Rodrigues Vianna', classificacao: 302 },
    { nome: 'Lady Maria Canhete Contrera', classificacao: 303 },
    { nome: 'Jeovana Lima Gavilan', classificacao: 304 },
    { nome: 'Munir Sami Campitelli Ibrahim', classificacao: 305 },
    { nome: 'Gabriel Rodrigues De Oliveira', classificacao: 306 },
    { nome: 'Alice Dos Santos Saab', classificacao: 307 },
    { nome: 'Diego Benedito Da Silva Moreira', classificacao: 308 },
    { nome: 'Edlene De Souza Haveroth', classificacao: 309 },
    { nome: 'Marlon Gabriel De Souza Silva', classificacao: 310 },
    { nome: 'Larissa Cruz Lopes', classificacao: 311 },
    { nome: 'Tamires Raquel Aguirre Arevalo', classificacao: 312 },
    { nome: 'Lincon Eder Ribeiro Valverde', classificacao: 313 },
    { nome: 'Luana Maria Sandim Santos', classificacao: 314 },
    { nome: 'Alex Lima De Souza', classificacao: 315 },
    { nome: 'Murilo De Souza Rodrigues', classificacao: 316 },
    { nome: 'Luiz Henrique Costa De Oliveira', classificacao: 317 },
    { nome: 'Vinicius De Araujo Marques', classificacao: 318 },
    { nome: 'Andrey Jeverson Pereira Da Silva Morais', classificacao: 319 },
    { nome: 'Andressa Sousa Santos Coqueiro', classificacao: 320 },
    { nome: 'Joshuan Sousa Valdez', classificacao: 321 },
    { nome: 'Fernando Pereira Sales', classificacao: 322 },
    { nome: 'Lucas Xavier De Souza Oba (Sub Judice)', classificacao: 323 },
    { nome: 'Jessika Ribeiro Mimoso', classificacao: 324 },
    { nome: 'Ana Carolina Ormond De Souza Carvalho', classificacao: 325 },
    { nome: 'Murilo Henrique Bezerra Araújo', classificacao: 326 },
    { nome: 'Daniel Guttemberg Ferreira De Brito', classificacao: 327 },
    { nome: 'Maycon Fernando Da Gloria Toledo', classificacao: 328 },
    { nome: "Andressa Da Silva Lovera", classificacao: 329 },
  { nome: "Joao Pedro Machado Neres", classificacao: 330 },
  { nome: "Bruna Pereira Schumann", classificacao: 331 },
  { nome: "Luiz Fernando Milagres Alves", classificacao: 332 },
  { nome: "Alan Da Silva Casal Batista", classificacao: 333 },
  { nome: "David Rodrigues Ribeiro", classificacao: 334 },
  { nome: "Luana Schubert", classificacao: 335 },
  { nome: "Rafael Peres Ramiro", classificacao: 336 },
  { nome: "Ludson De Lima Vargas", classificacao: 337 },
  { nome: "Rafaela Vieira Neiva", classificacao: 338 },
  { nome: "Thiago Ramos De Lima", classificacao: 339 },
  { nome: "João Pedro Dim Bergi", classificacao: 340 },
  { nome: "Djalma Henrique Rezende Veiga", classificacao: 341 },
  { nome: "Gisele Marques Da Silva", classificacao: 342 },
  { nome: "Gelson Firmo", classificacao: 343 },
  { nome: "Leonardo Felipe De Almeida", classificacao: 344 },
  { nome: "Vinnicius Silva Borges", classificacao: 345 },
  { nome: "Willia Lino Souza", classificacao: 346 },
  { nome: "Abimael Correia Marques", classificacao: 347 },
  { nome: "Luis Henrique Silva Leao", classificacao: 348 },
  { nome: "Paulo Ricardo Da Silva De Freitas", classificacao: 349 },
  { nome: "Marcelo Pimenta Da Silva", classificacao: 350 },
  { nome: "Vinicius Rovari De Cristo", classificacao: 351 },
  { nome: "Murilo Henrique Medeiros Rosa", classificacao: 352 },
  { nome: "Polyana Jessyca Felisardo Gonçalves Wruck", classificacao: 353 },
  { nome: "Jéssyca Ellen Weissinger", classificacao: 354 },
  { nome: "Henrique Bispo Vaz", classificacao: 355 },
  { nome: "Pablo Giovane De Oliveira De Souza Maldonado", classificacao: 356 },
  { nome: "Jessica Hillary Melo Sobrinho", classificacao: 357 },
  { nome: "Luan Matheus Da Silva Amorim", classificacao: 358 },
  { nome: "Laura Félix Barbosa", classificacao: 359 },
  { nome: "Jéferson Salla", classificacao: 360 },
  { nome: "Ulpiano Jacquet Filho", classificacao: 361 },
  { nome: "Rânily Ribeiro Graça", classificacao: 362 },
  { nome: "Camila Santiago Da Silva", classificacao: 363 },
  { nome: "Camila De Souza Gonçalves", classificacao: 364 },
  { nome: "Felipe Martins De Souza Costa", classificacao: 365 },
  { nome: "Jean Luca Dos Reis Bobadilha", classificacao: 366 },
  { nome: "Sidnei Gonçalves Ortega", classificacao: 367 },
  { nome: "Michael Carmona De Almeida", classificacao: 368 },
  { nome: "Mateus Penha Ribeiro Da Silveira", classificacao: 369 },
  { nome: "Mauro Vieira Da Costa", classificacao: 370 },
  { nome: "Talicia Camila Bezerra Carvalho", classificacao: 371 },
  { nome: "Débora De Souza Ferreira", classificacao: 372 },
  { nome: "Wanderson Bach Queiroz", classificacao: 373 },
  { nome: "Brenda Ferreira Caríssimo Picorelli", classificacao: 374 },
  { nome: "Ingrit Amarante Sabino De Oliveira", classificacao: 375 },
  { nome: "João Gabriel Mendes Chaves", classificacao: 376 },
  { nome: "Bruno Ferreira Peres", classificacao: 377 },
  { nome: "Renan Mamedes Delmão De Sena", classificacao: 378 },
  { nome: "Jônatas Triunfo Da Silva Nascimento", classificacao: 379 },
  { nome: "Vitor Nantes Lemos", classificacao: 380 },
  { nome: "Felipe Barros Garcia", classificacao: 381 },
  { nome: "Alisson Vinicius Da Silva Lima", classificacao: 382 },
  { nome: "Vinícius Moraes Menezes", classificacao: 383 },
  { nome: "Israel Pinto Da Silva Filho", classificacao: 384 },
  { nome: "Gustavo Metello", classificacao: 385 },
  { nome: "Evellyn Martinez Maia", classificacao: 386 },
  { nome: "Bruno Pereira Carvalho Barbosa", classificacao: 387 },
  { nome: "Alécio Andrade Leite", classificacao: 388 },
  { nome: "Bruna Larissa Gonçalves Pires", classificacao: 389 },
  { nome: "Felipe Rezende De Oliveira Lima", classificacao: 390 },
  { nome: "Nathalia Gonçalves Da Silveira", classificacao: 391 },
  { nome: "Gustavo Henrique Medeiros De Oliveira", classificacao: 392 },
  { nome: "Misael Lima De Mesquita Júnior", classificacao: 393 },
  { nome: "Daniel Kerestesi Freire", classificacao: 394 },
  { nome: "Laercio Cassel Dos Santos", classificacao: 395 },
  { nome: "Diego Henrique Da Silva Carvalho", classificacao: 396 },
  { nome: "Andressa Batista Espirito Santo", classificacao: 397 },
  { nome: "Rivelton Silva De Moraes", classificacao: 398 },
  { nome: "Caique Gomes De Oliveira", classificacao: 399 },
  { nome: "Nathalia Yasmine Tolentino Vilela", classificacao: 400 },
  { nome: "Nayanne Rodrigues Gervasio", classificacao: 401 },
  { nome: "Ana Júlia Barbosa Aguilera", classificacao: 402 },
  { nome: "Caio Lucas Oliveira Andrade", classificacao: 403 },
  { nome: "Andressa Porto De Oliveira", classificacao: 404 },
  { nome: "Mateus David Dutra Pereira", classificacao: 405 },
  { nome: "Cristiane Matos Da Silva", classificacao: 406 },
  { nome: "Lucas Mendonça Vargas", classificacao: 407 },
  { nome: "Wuilker Rafael Da Silva Garcia", classificacao: 408 },
  { nome: "Carlos Eduardo Dos Santos Dias", classificacao: 409 },
  { nome: "Leonardo Bruno Fernandes Moreira", classificacao: 410 },
  { nome: "Inara Freitas Do Nascimento", classificacao: 411 },
  { nome: "Kenia Rocha Tavares", classificacao: 412 },
  { nome: "Ivan Tobias De Oliveira", classificacao: 413 },
  { nome: "Eduardo Silveira Damaceno", classificacao: 414 },
  { nome: "Paulo Cesar De Souza Novaes", classificacao: 415 },
  { nome: "Wesley Joao Rodrigues", classificacao: 416 },
  { nome: "Tércio Arévalo De Aquino", classificacao: 417 },
  { nome: "Alan Nunes De Souza", classificacao: 418 },
  { nome: "Luiz Eduardo De Jesus Guedes", classificacao: 419 },
  { nome: "Antonio Luan De Lima", classificacao: 420 },
  { nome: "Leandro Dias Catellan Teixeira", classificacao: 421 },
  { nome: "Vinicius Henrique Gonçalves Portilho", classificacao: 422 },
  { nome: "Lucas Vinícius Almiron Dos Santos", classificacao: 423 },
  { nome: "Wender Pereira", classificacao: 424 },
  { nome: "Higor Rodrigues Oliveira", classificacao: 425 },
  { nome: "Vinicius Correa Bianco", classificacao: 426 },
  { nome: "Thais Ferreira Mendes", classificacao: 427 },
  { nome: "Iara Aparecida Ribeiro", classificacao: 428 },
  { nome: "Karoline Melo De Oliveira Pi Ferrario", classificacao: 429 },
  { nome: "Fernando Henrique Assis De Andrade", classificacao: 430 },
  { nome: "Leticia Dantas Da Silva (Sub judice)", classificacao: 431 },
  { nome: "Rafael Ferreira Segundo", classificacao: 432 },
  { nome: "Daniel Macedo Matos Da Silva", classificacao: 433 },
  { nome: "Gustavo Henrique Dos Santos Noetzold", classificacao: 434 },
  { nome: "Gabriel Felix Cabral", classificacao: 435 },
  { nome: "Milene Silva Lima Bomfim", classificacao: 436 },
  { nome: "Ingrid Tuanne Do Carmo Dias", classificacao: 437 },
  { nome: "Caio Da Silva Laguna", classificacao: 438 },
  { nome: "Marcus Vinycius Lourenço Ferreira", classificacao: 439 },
  { nome: "Jéssica Ayumi Uehara Aguilera", classificacao: 440 },
  { nome: "Bruno Henrique Da Silva Martins", classificacao: 441 },
  { nome: "Renan Wilson Varanis Da Silva", classificacao: 442 },
  { nome: "Renato Stoco De Machado", classificacao: 443 },
  { nome: "Renato De Alencar Ricaldes", classificacao: 444 },
  { nome: "Luany Thaynara Louzan", classificacao: 445 },
  { nome: "Adailton Pireli Costa", classificacao: 446 },
  { nome: "Igor Cesar Severo Antunes", classificacao: 447 },
  { nome: "Lucas Lincoln De Oliveira Matsumoto", classificacao: 448 },
  { nome: "Bruna Camila Ajala Araldi", classificacao: 449 },
  { nome: "Vinicius Araujo Soares", classificacao: 450 },
  { nome: "Jean Marcos Franco De Souza", classificacao: 451 },
  { nome: "Vinicius Guimaraes De Carvalho", classificacao: 452 },
  { nome: "Wilian Oliveira De Freitas", classificacao: 453 },
  { nome: "Fernando Numeriano De Oliveira", classificacao: 454 },
  { nome: "Lucas Calixto Paz Bezerra", classificacao: 455 },
  { nome: "Kelly Cristina Cândido Dos Santos", classificacao: 456 },
  { nome: "Isabela De Oliveira Da Riva", classificacao: 457 },
  { nome: "Weverton Gabriel De Barros Marques", classificacao: 458 },
  { nome: "Wevertton Cristiano Anjos Dos Santos", classificacao: 459 },
  { nome: "Lucas Dias Pinheiro", classificacao: 460 },
  { nome: "Jailzon Da Silva Rodrigues", classificacao: 461 },
  { nome: "Marcel Junio Da Silva Souza", classificacao: 462 },
  { nome: "Mailson Francisco Da Silva", classificacao: 463 },
  { nome: "Marcos Augusto De Sousa", classificacao: 464 },
  { nome: "Kaio Lima Da Silva", classificacao: 465 },
  { nome: "Rubiany Vasconcelos Duarte", classificacao: 466 },
  { nome: "Alan Carlos Miranda De Oliveira Cruz", classificacao: 467 },
  { nome: "Ronaldo Menão Jesus", classificacao: 468 },
  { nome: "Julia Beatriz Paz Pedroso", classificacao: 469 },
  { nome: "Ulisses Guimarães Sanches", classificacao: 470 },
  { nome: "Geraldo Claudio Pereira", classificacao: 471 },
  { nome: "Cleber Da Silva Ramirez", classificacao: 472 },
  { nome: "Mariana Pereira De Almeida", classificacao: 473 },
  { nome: "Pedro Paulo Machado Rodrigues", classificacao: 474 },
  { nome: "Joice Cristina Moreno Fernandes", classificacao: 475 },
  { nome: "João Victor Fagundes Silva", classificacao: 476 },
  { nome: "Nicole Bezerra Vaz", classificacao: 477 },
  { nome: "Beatriz Da Silva Pimenta", classificacao: 478 },
  { nome: "Ranon Louran Do Espirito Santo Costa", classificacao: 479 },
  { nome: "Mayse Rice Silveira Cardoso", classificacao: 480 },
  { nome: "Osvaldo Gonzalez", classificacao: 481 },
  { nome: "Mira Celi Nazare Dias Basilio", classificacao: 482 },
  { nome: "Steffano Mingotti Dias", classificacao: 483 },
  { nome: "Vitor Da Silva Lima", classificacao: 484 },
  { nome: "Murilo De Lima Silva", classificacao: 485 },
  { nome: "Raphaela Heloína Schiemann", classificacao: 486 },
  { nome: "Felipe Wellington De Oliveira Sousa", classificacao: 487 },
  { nome: "Marinara Alexandre Da Silva", classificacao: 488 },
  { nome: "Tiago Wisenfad Lopes", classificacao: 489 },
  { nome: "André Luiz Pereira Leite Junior", classificacao: 490 },
  { nome: "Edinei Machado De Almeida", classificacao: 491 },
  { nome: "Paulo Henrique Ferreira Do Nascimento", classificacao: 492 },
  { nome: "Aldair Canuto Do Nascimento", classificacao: 493 },
  { nome: "Fabrício Palmeira Rios Santos", classificacao: 494 },
  { nome: "Adna Da Silva Rabello", classificacao: 495 },
  { nome: "Léo De Medeiros Guimarães Neto", classificacao: 496 },
  { nome: "Ana Carolina Mugarte Potrich", classificacao: 497 },
  { nome: "Beatriz Carvalho Sottolano", classificacao: 498 },
  { nome: "Lucas Bryan Alencar De Oliveira", classificacao: 499 },
  { nome: "Rodrigo Da Rocha Rosati", classificacao: 500 },
  { nome: "Martinho Eduardo Pereira Filho", classificacao: 501 },
  { nome: "Juliana De Rezende De Souza", classificacao: 502 },
  { nome: "Jose Robson Sanabria Trindade", classificacao: 503 },
  { nome: "Rayani Barros Freitas", classificacao: 504 },
  { nome: "Daniela Oliveira De Souza", classificacao: 505 },
  { nome: "Flávio Luis Villalba Urquiza Junior", classificacao: 506 },
  { nome: "Gladison Bezerra Vieira", classificacao: 507 },
  { nome: "Vinícius Argemon Pereira Benites", classificacao: 508 },
  { nome: "Luiz Henrique Alves De Oliveira", classificacao: 509 },
  { nome: "Mateus Pinheiro De Oliveira", classificacao: 510 },
  { nome: "Jéssica Ferreira Cescon", classificacao: 511 },
  { nome: "Danielle Dos Santos Souza", classificacao: 512 },
  { nome: "Augusto Gameiro", classificacao: 513 },
  { nome: "Thiago Fagundes Lemos", classificacao: 514 },
  { nome: "José Eduardo Duarte Da Silva", classificacao: 515 },
  { nome: "Icaro Almeida Lemos Alves", classificacao: 516 },
  { nome: "Lauro Dalaqua Junior", classificacao: 517 },
  { nome: "Fernando Jorge De Lima", classificacao: 518 },
  { nome: "Ana Paula Rezende Dos Santos", classificacao: 519 },
  { nome: "Sindi Sabrina Pedroso Cubilla", classificacao: 520 },
  { nome: "Gustavo Da Silva Aparecido", classificacao: 521 },
  { nome: "Samuel Lucas Diniz", classificacao: 522 },
  { nome: "Cleber Da Silva", classificacao: 523 },
  { nome: "Daniel Almada Messa", classificacao: 524 },
  { nome: "Danilo Eugênio Ferreira Moraes", classificacao: 525 },
  { nome: "Rafaely Carvalho Alves", classificacao: 526 },
  { nome: "Viviane Inez Satirito Silvestre", classificacao: 527 },
  { nome: "Gleidson Souza Carvalho", classificacao: 528 },
  { nome: "Raul Do Amaral Vieira", classificacao: 529 },
  { nome: "Gabriella Gazola De Melo", classificacao: 530 },
  { nome: "Junio Ferreira Da Silva", classificacao: 531 },
  { nome: "Carlos Pedro Meiato Da Silva", classificacao: 532 },
  { nome: "Alison Perira Braga", classificacao: 533 },
  { nome: "Leandro Barros Schencknecht", classificacao: 534 },
  { nome: "Bruna Ferreira Garbin", classificacao: 535 },
  { nome: "Gabriel Martins Duarte", classificacao: 536 },
  { nome: "Sanny Mara Dos Santos Lima", classificacao: 537 },
  { nome: "Larissa Dos Santos Costa", classificacao: 538 },
  { nome: "Anay Crystyna Freitas De Souza", classificacao: 539 },
  { nome: "Henrique De Souza Santos", classificacao: 540 },
  { nome: "Matheus Almeida De Moura Monteiro De Oliveira", classificacao: 541 },
  { nome: "Fernanda Antunes Rezende", classificacao: 542 },
  { nome: "Lucas Costa Soares", classificacao: 543 },
  { nome: "Emilly De Lima Moraes", classificacao: 544 },
  { nome: "Rafael Madeira De Oliveira", classificacao: 545 },
  { nome: "Érica Freitas Rojas Vieira", classificacao: 546 },
  { nome: "Natalia Ester Correa Ramalho", classificacao: 547 },
  { nome: "Vitor Augusto Souza De Carvalho", classificacao: 548 },
  { nome: "Sayuri Hirasaka", classificacao: 549 },
  { nome: "Lethicia Megaioli De Oliveira", classificacao: 550 },
  { nome: "Adeandrea Peixoto Moraes Santana", classificacao: 551 },
  { nome: "Willian Costa Dias", classificacao: 552 },
  { nome: "Alexandre Rosa Flores", classificacao: 553 },
  { nome: "Luiz Pegoraro Junior", classificacao: 554 },
  { nome: "Danilo Maciel De Lima", classificacao: 555 },
  { nome: "Thiago Da Silva Martins", classificacao: 556 },
  { nome: "Pâmela Fernandes Pereira", classificacao: 557 },
  { nome: "Junior Hoinoski Cordeiro", classificacao: 558 },
  { nome: "Diego Pereira Coelho", classificacao: 559 },
  { nome: "Luiz Henrique Silva Dos Santos", classificacao: 560 },
  { nome: "Raiane Da Silva", classificacao: 561 },
  { nome: "Bianca Marques Dos Santos", classificacao: 562 },
  { nome: "Haryson Lucas De Souza Jorge", classificacao: 563 },
  { nome: "Petronio Neres Da Silva", classificacao: 564 },
  { nome: "Luana Neves Da Silva", classificacao: 565 },
  { nome: "Munyr Luna Barion", classificacao: 566 },
  { nome: "Rodrigo Orro De Campos Viega", classificacao: 567 },
  { nome: "Jó Noélcio Anoar De Melo Ávila", classificacao: 568 },
  { nome: "Regiane Vitoria Perin Ortega", classificacao: 569 },
  { nome: "Bruno Gracini Macedo", classificacao: 570 },
  { nome: "Joilhan Kelvis De Assis Pires", classificacao: 571 },
  { nome: "Rafael Angelozi De Souza", classificacao: 572 },
  { nome: "Jean Carlos De Freitas Da Silva", classificacao: 573 },
  { nome: "Pedro Henrique Fuzario Custodio", classificacao: 574 },
  { nome: "Weslen Dos Santos Resende", classificacao: 575 },
  { nome: "Jeferson Rolon De Assis", classificacao: 576 },
  { nome: "Farney Mendes Fontoura", classificacao: 577 },
  { nome: "Matheus Andriu De Miranda Silva", classificacao: 578 },
  { nome: "Jéfiton De Souza Polidório", classificacao: 579 },
  { nome: "Matheus Henrique De Lima Vilela", classificacao: 580 },
  { nome: "Eziel Do Amaral Centurion", classificacao: 581 },
  { nome: "Abimael Vicente De Souza Machado", classificacao: 582 },
  { nome: "Wagner Alves Pereira", classificacao: 583 },
  { nome: "Paulliane Martins Souza", classificacao: 584 },
  { nome: "Jeferson Saucedo Amorim", classificacao: 585 },
  { nome: "Willian Villamayor Fernandes Da Silva", classificacao: 586 },
  { nome: "Diego Da Silva Souza", classificacao: 587 },
  { nome: "Lucas Vaz Nemezio Da Silva Silveira", classificacao: 588 },
  { nome: "Ana Paula Fortes", classificacao: 589 },
  { nome: "Pamela Ferraz De Albuquerque", classificacao: 590 },
  { nome: "Wenderson Da Silva Cavalcante", classificacao: 591 },
  { nome: "Thécia Lourenço Furtado", classificacao: 592 },
  { nome: "Alisson Araujo Ferreira", classificacao: 593 },
  { nome: "Gabriel Abrahão Gomes De Oliveira", classificacao: 594 },
  { nome: "Fuad Alessandro Gonçalves Da Rocha", classificacao: 595 },
  { nome: "Rodrigo Onofre Maurer Tavares", classificacao: 596 },
  { nome: "Rafael Torquato De Escobar", classificacao: 597 },
  { nome: "Amanda Da Silva Gomes", classificacao: 598 },
  { nome: "Fabricio Santos E Costa Salgado", classificacao: 599 },
  { nome: "Matheus Dos Santos Pitol", classificacao: 600 },
  { nome: "Leonardo Da Rosa Aivi", classificacao: 601 },
  { nome: "Giullian Batista Vialle", classificacao: 602 },
  { nome: "Lincoln Calistro Berro", classificacao: 603 },
  { nome: "Jose Gomes Pereira Neto", classificacao: 604 },
  { nome: "Natalia Evelin Alves Dos Reis", classificacao: 605 },
  { nome: "Isabella Fidelis", classificacao: 606 },
  { nome: "Carlos Eduardo Da Silva Filho", classificacao: 607 },
  { nome: "Matheus Ferreira Sonohata", classificacao: 608 },
  { nome: "Raphael Vilalva De Queiroz", classificacao: 609 },
  { nome: "Lucas Ovelar Leme", classificacao: 610 },
  { nome: "Eduardo Santana De Moura Sousa", classificacao: 611 },
  { nome: "Wellington Flores De Castro", classificacao: 612 },
  { nome: "Tiago Andre Da Silva Dias", classificacao: 613 },
  { nome: "Cássio Sales Cassimiro", classificacao: 614 },
  { nome: "Luciane Oliveira Portela Pissini", classificacao: 615 },
  { nome: "Gabriel Schmitt Schroeder", classificacao: 616 },
  { nome: "Daniel Nunes Guimarães", classificacao: 617 },
  { nome: "Julio Cesar Seccatto", classificacao: 618 },
  { nome: "Fernanda Mortari Végas", classificacao: 619 },
  { nome: "Deivid An Martins De Arruda", classificacao: 620 },
  { nome: "Marcos Eloy Giron", classificacao: 621 },
  { nome: "Thiago Aparecido Ramos Pertile", classificacao: 622 },
  { nome: "Laurielene Elen Arruda Silva Deodato", classificacao: 623 },
  { nome: "Heloísa Polacchine Leite", classificacao: 624 },
  { nome: "Bárbara Marinho Azevedo", classificacao: 625 },
  { nome: "Cristhian Freitas Batista", classificacao: 626 },
  { nome: "Julio Cesar Torres Junior", classificacao: 627 },
  { nome: "Raul Murilo Camacho Seba", classificacao: 628 },
  { nome: "Carlos Henrique Cabanhas De Oliveira", classificacao: 629 },
  { nome: "Fani Elizabeth Ojeda", classificacao: 630 },
  { nome: "José Fernando Manzione Paes De Barros", classificacao: 631 },
  { nome: "Caio Alexandre Navarro Antonio", classificacao: 632 },
  { nome: "Mikael Dos Santos Ortiz", classificacao: 633 },
  { nome: "Carlos Eduardo Martins Silva", classificacao: 634 },
  { nome: "Gabriel Florenciano Ferreira", classificacao: 635 },
  { nome: "Adeilson Rodrigues Faria", classificacao: 636 },
  { nome: "Watson Lima Da Silva", classificacao: 637 },
  { nome: "Leonardo Paniago Teodoro Almeida", classificacao: 638 },
  { nome: "José Euclides Da Silva Neto", classificacao: 639 },
  { nome: "Michele Kuchar Matte", classificacao: 640 },
  { nome: "Wanderley Campos Pereira Junior", classificacao: 641 },
  { nome: "Rhaiana Borges Pereira", classificacao: 642 },
  { nome: "Hayana Fardim Da Gama", classificacao: 643 },
  { nome: "Pamela Aparecida Azevedo De Paula", classificacao: 644 },
  { nome: "Huender Lucas Farias De Sousa", classificacao: 645 },
  { nome: "Lucas Barros Garcia", classificacao: 646 },
  { nome: "Luiz Felippe Antunes Ribeiro", classificacao: 647 },
  { nome: "Natália Godoi De Oliveira Fagundes", classificacao: 648 },
  { nome: "Daniel Paredes De França", classificacao: 649 },
  { nome: "Millena Christine Dezan Da Fonseca", classificacao: 650 },
  { nome: "Leandro Hideyuki Mori", classificacao: 651 }
];
...
const nomeInicio = "OSVALDO GONZALEZ";
    ...
    async function verificarEAtualizarClassificacaoCandidatos() {
      try {
        ...
        for (const usuario of usuarios) {
          ...
          const nomeBanco = data.nome; // Nome no banco de dados em letras maiúsculas
    ...
    async function exibirCandidatosNaoCadastrados() {
      try {
        // Obter todos os usuários cadastrados
        const userSnapshot = await getDocs(collection(db, "users"));
        const cadastrados = new Set(userSnapshot.docs.map(doc => doc.data().nome));
    
        // Filtrar candidatos que não estão cadastrados
        const naoCadastrados = nomesCandidatos.filter(nome => !cadastrados.has(nome));
    
        // Formatar a mensagem
        if (naoCadastrados.length === 0) {
          toast.info("Todos os candidatos estão cadastrados.", { className: 'toast-info' });
        } else {
          const mensagem = `Candidatos não cadastrados:\n${naoCadastrados.join('\n')}`;
          toast.info(mensagem, { className: 'toast-info' });
        }
      } catch (error) {
        console.error("Erro ao listar candidatos não cadastrados:", error);
        toast.error("Erro ao verificar candidatos.", { className: 'toast-error' });
      }
    }
    ...
    async function signIn(email, password) {
      ...
      try {
        ...
        exibirCandidatosNaoCadastrados();
